...
export default function MainHeader({ClothingChange}:{ClothingChange: (activeindex: number) => void}){
    ...
    return(<div className="relative w-full h-full flex flex-row justify-between items-top">
        ...
        <Header ClothingChange={(activeindex: number) => {console.log("Index Change in header: ",activeindex); ClothingChange(activeindex)}}/>
        </div>
